...
#* Globals *#
script_loc = getwd()
setwd("/Users/guillermotorres/Documents/Proyectos/Doctorado/Metagenome/networks/")
files.path = '/Users/guillermotorres/Documents/Proyectos/Doctorado/Metagenome/Madrid/bin/'#
prefix <- "JP_"



m_wdeg <- read.table(paste(files.path,'OTUp/OTUp_males_t01_wdegree.txt',sep=''),header=T,sep="\t")
f_wdeg <- read.table(paste(files.path,'OTUP/OTUp_females_t01_wdegree.txt',sep=''),header=T,sep="\t")
...
pdf("JP_strength.pdf", pointsize = 12, width = 10 , height = 7 ) 
ggplot(data=m_wdSE,aes(X,value,color=gender))+geom_line()+geom_point()+
...
#----------------------------------#
OTU <- read.table(paste(files.path,'OTUp_t01/OTUp_males_33.3_t01.txt',sep=''),header=T,sep="\t")
OTU <- read.table(paste(files.path,'OTUp_t01/OTUp_females_34.0.txt',sep=''),header=T,sep="\t")
